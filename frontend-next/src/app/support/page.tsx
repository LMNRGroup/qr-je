...
import { Mail, Clock, HelpCircle, FileText, Shield, MessageSquare } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Support & Contact | QR Code Studio',
  description: 'Help topics and how to contact QR Code Studio support.',
};
          ...
          <div className="flex items-start gap-4 pt-4 border-t border-border/50">
            ...
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li><strong>Data deletion requests:</strong> 48-72 hours (see <Link href="/data-deletion" className="text-primary hover:underline">Data Deletion Instructions</Link>)</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="glass-panel rounded-2xl p-6 space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 ml-4 list-disc">
              <li><strong>Data deletion:</strong> See our <Link href="/data-deletion" className="text-primary hover:underline">Data Deletion Instructions</Link> for how to request account and data deletion.</li>
              <li><strong>Privacy questions:</strong> See our <Link href="/privacy" className="text-primary hover:underline">Privacy Policy</Link> for details on data collection and usage.</li>
            </ul>
          </div>
        </div>
      </div>
